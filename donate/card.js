...
function doFun(){
 tColorA.style.color = "#0b5ed7";
 tColorB.style.color = "#444";
 tColorC.style.color = "#444";
 iconA.style.color = "#0b5ed7";
...
function doFunA(){
 ...
 tColorB.style.color = "#0b5ed7";
 tColorC.style.color = "#444";
 iconA.style.color = "#aaa";
 iconB.style.color = "#0b5ed7";
 iconC.style.color = "#aaa";
...
function doFunB(){
 tColorA.style.color = "#444";
 tColorB.style.color = "#444";
 tColorC.style.color = "#0b5ed7";
 iconA.style.color = "#aaa";
 iconB.style.color = "#aaa";
 iconC.style.color = "#0b5ed7";
 cDetails.style.display = "none";
}
...
cNumber.addEventListener('keyup', function(e){
 ...
 if(num.length<16){
  ...
  ccNum.style.border="1px solid #0b5ed7";
 }
});
...
eDate.addEventListener('keyup', function( e ){
 ...
 if(newInput.length<5){
  ...
  eDate.style.border="1px solid #0b5ed7";
 }
});
...
cvv.addEventListener('keyup', function(e){
 ...
 if(elen.length<3){
  ...
  cvvBox.style.border="1px solid #0b5ed7";
 }
})
